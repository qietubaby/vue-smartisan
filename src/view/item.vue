				...
				<div class="item-box">
					<div class="gallery-wrapper">
						<div class="gallery">
							<div class="thumbnail">
								<ul>
									<li @click="tableImg(index)" :class="{'on':index==imgIndex}" v-for="img,index in itemInfo.ali_images"><img :src="img+'?x-oss-process=image/resize,w_53/quality,Q_90/format,webp'">
									</li>
								</ul>
							</div>
							<div class="thumb">
					...
					<div class="banner">
							...
							<div class="sku-dynamic-params clear">
								...
								<div class="params-detail clear">
									<div class="item-num js-select-quantity">
										<span @click="subCount" class="down" :class="{'down-disabled':count<=1}">-</span>
										<span class="num">{{count}}</span>
										<span @click="addCount" class="up" :class="{'up-disabled':count>=itemInfo.limit_num}">+</span>
									</div>
								</div>
							</div>
						</div>
						<div class="sku-status">
							<div class="cart-operation-wrapper clearfix">
								<span @click="addCarPanelHandle" class="blue-title-btn js-add-cart"><a>加入购物车</a></span>

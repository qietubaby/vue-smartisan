	...
	<div id="main" class="hander-car">
			<div class="store-content">
				<div class="cart-box">
									...
									<div class="cart-top-items" v-for="item,index in carPanelData">
										<div class="cart-items">
											<div class="items-choose">
												<span class="blue-checkbox-new" @click="checkGoodsHandle(item.sku_id)" :class="{'checkbox-on':item.checked}"><a></a></span>
											</div>
											...
											<div class="item-cols-num">
												<div class="select js-select-quantity">
													<span class="down" @click="subCarPanelDataHandle(item.sku_id)" :class="{'down-disabled':item.count<=1}">-</span>
													<span class="num">
														{{item.count}}
					...
					<div class="cart-bottom-bg fix-bottom" v-if="count>=1">
						<div class="cart-bar-operation">
							<div>
								<div class="choose-all js-choose-all">
									<span @click="allCheckGoodsHandle(allChecked)" class="blue-checkbox-new" :class="{'checkbox-on':allChecked}"><a></a></span>
									全选
								</div>
								<div @click="delCheckGoodsHandle" class="delete-choose-goods">删除选中的商品</div>
							</div>
						</div>
						<div class="shipping">
                ...
                <router-link :class="{'disabled-btn':checkedCount<=0}" class="jianguo-blue-main-btn big-main-btn js-checkout " tag="span" to="/checkout"><a>现在结算</a></router-link>
